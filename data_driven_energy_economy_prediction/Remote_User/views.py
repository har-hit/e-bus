...
def Predict_Energy_Economy_Type(request):
    if request.method == "POST":
        ...
        if request.method == "POST":
            ...
            AccelSec=request.POST.get('AccelSec')
            TopSpeed_KmH=request.POST.get('TopSpeed_KmH')
            Range_Km=request.POST.get('Range_Km')
            Efficiency_WhKm=request.POST.get('Efficiency_WhKm')
            FastCharge_KmH=request.POST.get('FastCharge_KmH')
            RapidCharge=request.POST.get('RapidCharge')
            PowerTrain=request.POST.get('PowerTrain')
            PlugType=request.POST.get('PlugType')
            BodyStyle=request.POST.get('BodyStyle')
            Segment=request.POST.get('Segment')
            Charging_Price=request.POST.get('Charging_Price')
        ...
        return render(request, 'RUser/Predict_Energy_Economy_Type.html',{'objs': val})
